...
public class WeakSlashAction : UnitAction {
	...
	public WeakSlashAction(Unit unit, HighlighterManager highlighterManager, GameObject slashPrefab) : base(true, false, 4, unit, UnitActionType.WEAK_SHLASH, highlighterManager) {
	...
	public override void doAction (Vector2i position) {
		Debug.LogWarning("Can't do WeakSlashAction @ position");
	}
