...
public class SlashAction : UnitAction {
	...
	public SlashAction(Unit unit, HighlighterManager highlighterManager, GameObject slashPrefab) : base(true, false, 6, unit, UnitActionType.SLASH, highlighterManager) {
